...
const Header = () => {
  ...
  return (
    ...
    >Unleash your creativity with AI.Turn your imagination into visual art in seconds - just type and watch the magic</motion.p>
    ...
    whileTap={{scale:0.95}}
    initial={{opacity: 1}}
    transition={{default: {duration:0.5},opacty:{delay:0.8, duration: 1}}}
    ...
    className='mt-2 text-neutral-600'>Genarated images form imagify</motion.p>
    </motion.div>
