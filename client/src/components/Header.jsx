...
const Header = () => {
  return (
    ...
    <p className='text-center max-w-xl mx-auto mt-5'>Unleash your creativity with AI.Turn your imagination into visual art in seconds - just type and watch the magic</p>
    ...
    <p className='mt-2 text-neutral-600'>Genarated images form imagify</p>
    </div>
