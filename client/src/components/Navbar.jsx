...
const Navbar = () => {
  ...
  const navigate= useNavigate() /*to navigate pricing icon on navbar to price page*/
    ...
    <div className='flex items-center justify-between py-4'>
      ...
      <div>
        ...
        <div className='flex items-center gap-2 sm:gap-3 '>
          ...
          <p className='text-gray-600 max-sm:hidden pl-4'>Hi, Buddy</p>
