...
const Result = () => {
 ...
 const [input,setInput]=useState('') //user in[ut will be stored in this state
 ...
 const onSubmitHandler =async (e)=>{
  ...
  {!isImageLoaded && 
    <div className='flex w-full max-w-xl bg-neutral-500 text-white 
     ...
     type="text" placeholder='Describe what image you want to generate' className='flex-1 bg-transparent outlin-none ml-8
  ...
  {isImageLoaded &&
   <div className='flex gap-2 flex-wrap justify-center text-white text-sm p-0.5 mt-10 rounded-full' >
      <p onClick = {()=>{setIsImageLoaded(false)}}  
         className='bg-transparent border boreder-zinc-900 text-black px-8 py-3 rounded-full cursor-pointer'>Generate Another</p>
      <a href="image" download className='bg-zinc-900 px-10 py-3 rounded-full cursor-pointer'>Downlaod</a>
   </div>
  }
